...
<head>
	...
	@vite('resource/css/skilline.css')
...
<div x-data="{ open: false }" class="w-full text-gray-700 bg-cream">
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
        ...
        <nav :class="{ 'scale-y-100 h-full text-blue-500': open, 'scale-y-0 h-0': !open }" class="origin-top transform transition duration-300 md:scale-y-100 md:h-auto flex flex-col md:items-center pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
            <a :class="{ 'text-blue-500': open }" class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Home</a>
            <a :class="{ 'text-blue-500': open }" class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Careers</a>
            <a :class="{ 'text-blue-500': open }" class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Blog</a>
            <a :class="{ 'text-blue-500': open }" class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">About Us</a>
            <a :class="{ 'text-blue-500': open }" class="px-10 py-3 mt-2 text-sm text-center bg-white text-gray-800 rounded-full md:mt-8 md:ml-4" href="#">Login</a>
            <a :class="{ 'text-blue-500': open }" class="px-10 py-3 mt-2 text-sm text-center bg-yellow-500 text-white rounded-full md:mt-8 md:ml-4" href="#">Sign Up</a>
        </nav>
    </div>
</div>
